                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="gender" type="radio" class="form-check-input" name="gender" value="Male" required>Male
                                <input id="gender" type="radio" class="form-check-input" name="gender" value="Female" required>Female
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="gender" class="col-md-4 control-label">Alamat</label>
